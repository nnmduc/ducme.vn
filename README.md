...
[![Tests](https://img.shields.io/badge/Tests-384%20passing-brightgreen.svg)](#kiểm-thử-toàn-vẹn-dữ-liệu)
...
├── tests/
│   └── test_data_and_integrity.js # Bộ 384 bài kiểm thử tính toàn vẹn dữ liệu & backend
...
Dự án sở hữu bộ kiểm thử nghiêm ngặt gồm **384 điều kiện kiểm thử** độc lập trong `tests/test_data_and_integrity.js`, đảm bảo dữ liệu và cấu hình hệ thống không bao giờ bị sai lệch:
