 ...
 *
 * Cach dung:
 *   node .claude/skills/marian-pipeline/scripts/format-run.mjs <id> [--html] [--stdout] [--check]
 */
...
if (!id) {
  console.error('Thieu id. Vi du: node .claude/skills/marian-pipeline/scripts/format-run.mjs nuicui --html');
  process.exit(1);
}
