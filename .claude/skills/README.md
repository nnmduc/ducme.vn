...
Bộ skill này chạy trên cả Claude Code (`.claude/skills/`) và Antigravity (`.agents/skills/`). Bản gốc
...
Sửa skill thì sửa trong `.claude/skills/` rồi chạy lệnh trên. **Không sửa tay file nào trong
