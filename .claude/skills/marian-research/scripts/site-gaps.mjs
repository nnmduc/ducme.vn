 ...
 *
 * Cach dung:
 *   node .claude/skills/marian-research/scripts/site-gaps.mjs
 *   node .claude/skills/marian-research/scripts/site-gaps.mjs --id honchong
 *   node .claude/skills/marian-research/scripts/site-gaps.mjs --json
 */
