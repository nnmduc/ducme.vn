 ...
 *
 * Cach dung:
 *   node .agents/skills/marian-publish/scripts/read-handoff.mjs docs/khao-cuu/<id>/
 *   node .agents/skills/marian-publish/scripts/read-handoff.mjs <id>        # tu tim trong docs/khao-cuu/
...
if (!target) {
  ...
  console.error('  node .agents/skills/marian-publish/scripts/read-handoff.mjs nuicui [--html]');
  process.exit(1);
}
...
P();
P('- [ ] `node .agents/skills/marian-publish/scripts/validate-record.mjs <file record> --allow-existing-id` — hết lỗi chặn');
