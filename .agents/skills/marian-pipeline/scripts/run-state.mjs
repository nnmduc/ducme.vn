 ...
 *
 * Cach dung:
 *   node .agents/skills/marian-pipeline/scripts/run-state.mjs init <id> [--no-pr] [--max-rounds 2]
 ...
 *   node .agents/skills/marian-pipeline/scripts/run-state.mjs record <id> --step <buoc> --result <xong|loi> [--note "..."] [--agent "..."]
 *
 ...
 *   node .agents/skills/marian-pipeline/scripts/run-state.mjs finish <id> --status <trang-thai> [--note "..."] [--branch "..."] [--pr "..."]
 *
