...
```
Đọc .agents/skills/marian-research/SKILL.md và làm đúng theo đó.

## Việc phải làm
Khảo cứu linh địa "<tên>" (mã: <id>) cho website ducme.vn, từ đầu.

## Được đọc
- .agents/skills/marian-research/SKILL.md và toàn bộ references/ của nó
- .agents/skills/_lib/examples/khao-cuu.example.json (khung sao chép)
...
## Xong việc nghĩa là
1. `node .agents/skills/marian-publish/scripts/validate-record.mjs docs/khao-cuu/<id>/khao-cuu.json` không còn lỗi chặn
   (thêm --allow-existing-id nếu đây là bản cập nhật cho linh địa đã có trong dữ liệu)
2. `node .agents/skills/marian-research/scripts/format-report.mjs docs/khao-cuu/<id>/khao-cuu.json --check` sạch
3. `node .agents/skills/marian-research/scripts/format-report.mjs docs/khao-cuu/<id>/khao-cuu.json --html` đã chạy
...
## Đọc
- .agents/skills/marian-research/references/ho-so-khao-cuu.md (lược đồ đầy đủ)
...
```
Đọc .agents/skills/marian-audit/SKILL.md và làm đúng theo đó.
...
- .agents/skills/marian-audit/SKILL.md và references/tieu-chi-kiem-chung.md, references/ho-so-kiem-chung.md
- .agents/skills/_lib/examples/kiem-chung.example.json
...
## Xong việc nghĩa là
1. Đã chạy `node .agents/skills/marian-audit/scripts/check-sources.mjs --file docs/khao-cuu/<id>/khao-cuu.json`
2. Đã chạy `node .agents/skills/marian-publish/scripts/validate-record.mjs docs/khao-cuu/<id>/khao-cuu.json`
...
7. `node .agents/skills/marian-audit/scripts/format-audit.mjs docs/khao-cuu/<id>/kiem-chung.json --check` sạch
8. `... --html` đã chạy
...
```
Đọc .agents/skills/marian-publish/SKILL.md và làm đúng theo đó.
...
3. Đã chạy `node .agents/skills/marian-pipeline/scripts/format-run.mjs <id> --html` NGAY TRƯỚC `git add`
